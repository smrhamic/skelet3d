...
The preliminary design of the application is shown in diagram \ref[class_diag1], roughly following a MVC architecture. Individual components are described below.
...
The visible website itself (leftmost grey box in diagram \ref[class_diag1]) represents the View in our MVC architecture.
