...
The preliminary design of the application is shown in diagram \ref[class_diag1], roughly following a \glref{MVC} architecture. Individual components are described below.
